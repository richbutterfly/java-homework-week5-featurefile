Feature: Nopcommerce Registration
  ...
  Scenario Outline: I should not able to register with Invalid data on mandatory field (*) of registration page
    ...
    Examples:
      ...
      | Rohan      | bakshi    | " "              | 456897   | 456987           | please enter valid email Id                |
      ...
      | Rohan      | baksi     | bakshi@gmail.com | 456897   | 45689            | password and confirm password do not match |
  ...
  Scenario: I should be able to select any one radio button from Gender Label of your Personal Details section
    ...
    Then    I am able to select any one of the radio buttton

  Scenario Outline: I should be able to select Day, Month and Year from drop down list od Date of birth field
    Given   I am on Date of Birth field of Your Personal Detail section
    When    I select day "<Day>"
    And     I select month "<Month>"
    And     I selecct year "<Year>"
