Feature: Demo Nopcommerce top menu's acceptance criteria
  ...
  Scenario: Verify that user can see 'Display' tab on Book Category page
    Given   User is on Books Category page
    When    User is on Books Category page
  ...
  Scenario: Verify that user can see 'Name: A to Z' selection is present in 'Sort by' filter
    Given   User is on Books Category page
    When    User is on Books Category page
    And     Click on 'Sory by' filter
    And     Check that 'Name: A to Z' selection is present

  Scenario: Verift that user can see 'Name: A to Z' is first option in 'Sort by' filter
    Given   User is on Books Category page
    When    User is on Books Category page
    And     Click on 'Sort by' filter
    And     Check that 'Name: A to Z' is forst in order
    Then    'Name: A to Z' is first oprion in order
